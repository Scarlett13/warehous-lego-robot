 ...
 * JADE, runs agents of a {@link bdi4jade.examples.BDI4JADEExamplesPanel}, and makes a GUI visible
...
//				.getResource("log4j2.configurationFile").toURI());
	...
	private final bdi4jade.examples.BDI4JADEExamplesPanel agentTestPanel;
	...
	public BDI4JADEExamplesApp() {
		...
		this.agentTestPanel = new bdi4jade.examples.BDI4JADEExamplesPanel();
