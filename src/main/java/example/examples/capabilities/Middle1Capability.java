...
package example.examples.capabilities;
...
import bdi4jade.examples.capabilities.SuccessPlanBody;
import bdi4jade.examples.capabilities.TestPlanBody;
...
public class Middle1Capability extends Middle1ParentCapability {
	...
	private Plan externalGoalPlan = new DefaultPlan(Middle1ExternalGoal.class,
			bdi4jade.examples.capabilities.SuccessPlanBody.class);
