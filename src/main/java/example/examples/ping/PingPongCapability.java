...
package example.examples.ping;

import bdi4jade.annotation.Belief;
import bdi4jade.annotation.GoalOwner;
import bdi4jade.core.Capability;
import bdi4jade.examples.ping.PingPlanBody;
import bdi4jade.examples.ping.PongPlanBody;
...
public class PingPongCapability extends Capability {
	...
	private Plan pingPlan = new DefaultPlan(PingGoal.class, bdi4jade.examples.ping.PingPlanBody.class);
