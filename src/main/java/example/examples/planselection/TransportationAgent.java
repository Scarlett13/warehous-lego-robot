...
public class TransportationAgent extends SingleCapabilityAgent {
	...
	protected void init() {
		for (Softgoal softgoal : bdi4jade.examples.planselection.Softgoals.SOFTGOALS) {
		...
		getCapability().getBeliefBase().addBelief(
				new TransientBelief<String, bdi4jade.examples.planselection.GenericValueFunction<Integer>>(
