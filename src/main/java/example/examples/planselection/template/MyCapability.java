...
package example.examples.planselection.template;
...
public class MyCapability extends UtilityBasedCabability {
	...
	protected void setup() {
		for (Softgoal softgoal : bdi4jade.examples.planselection.template.MyAgentSoftgoals.ALL_SOFTGOALS) {
	...
	public void initPreferences() {
		this.softgoalPreferences.setPreferenceForSoftgoal(
				bdi4jade.examples.planselection.template.MyAgentSoftgoals.Softgoal1, 0.3);
		this.softgoalPreferences.setPreferenceForSoftgoal(
