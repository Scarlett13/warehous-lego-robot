...
//            p.setParameter(Profile.LOCAL_HOST, "192.168.0.222");
            ...
            System.out.println("[Boot] CONFIGURING JADE:");
            System.out.println("   LOCAL_HOST: " + p.getParameter(Profile.LOCAL_HOST, "unknown"));
            System.out.println("   LOCAL_PORT: " + p.getParameter(Profile.LOCAL_PORT, "unknown"));
            System.out.println("   MAIN_HOST:  " + p.getParameter(Profile.MAIN_HOST, "unknown"));
            System.out.println("   MAIN_PORT:  " + p.getParameter(Profile.MAIN_PORT, "unknown"));
            ...
            // System.out.println("[Boot] SERVICES=" + p.getParameter(Profile.SERVICES,
            // null));
            ...
            System.err.println("CRITICAL ERROR STARTING ROBOT CONTAINER:");
            e.printStackTrace();
        }
    }
