...
public class Constants {
    ...
    // -------- Goal thresholds (mm) --------
    public static final double DEST_GOAL_STOP   = 550;  // 1) reaching destination
    public static final double DEST_GOAL_TURN   = 300.0;  // 4) begin turn bias toward destination
    public static final double DEST_GOAL_SLOW   = 300.0;  // 3) slow down window
    ...
    // -------- Loop timing --------
    public static final int LOOP_HZ = 10;

    // Topics
    public static final String US_DISTANCE_TOPIC    = "teletubbies_ultrasonic";
    public static final String POSITION_TOPIC       = "teletubbies_position";
    public static final String SPEED_PID_TOPIC      = "teletubbies_speed_pid";
    public static final String DESTINATION_TOPIC    = "teletubbies_destination";
    public static final String ROBOT_STATE_TOPIC    = "teletubbies_state";
    public static final String ROBOT_TURN_TOPIC    = "teletubbies_turn";
