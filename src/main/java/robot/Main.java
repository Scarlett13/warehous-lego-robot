...
public class Main {
    ...
    // -------- Distances (cm) --------
    public static final double STOP_CM    = 8.0;     // hard stop threshold
    public static final double RESUME_CM  = 12.0;    // resume once above this
    public static final double AVOID_CM   = 35.0;    // begin avoidance turning below this
    public static final double FAR_CM     = 200.0;   // distance mapped to max speed
    public static final double MAX_CM     = 250.0;   // sensor max for filtering

    // -------- Motor & control limits --------
    public static final double SPEED_MIN  = 320.0;   // deg/s (to overcome stiction)
    public static final double SPEED_MAX  = 720.0;   // deg/s
    public static final double TURN_MAX   = 0.60;    // max |turn| fraction
    public static final double SLEW_RATE  = 180.0;   // deg/s², smoothing in mixer
    ...
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                ...
                // 1) Distance (median of 7, drop > MAX_CM)
