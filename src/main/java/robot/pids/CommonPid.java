 ...
 * Minimal usage:<br>
 * CommonPid pid = new CommonPid(p,i,d); <br>
 * ...looping code...{ <br>
...
public class CommonPid{
    ...
    /**
     * Create a CommonPid class object. 
     ...
     */
    public CommonPid(double p, double i, double d){
        P=p; I=i; D=d;
        checkSigns();
    }
     ...
     */
    public CommonPid(double p, double i, double d, double f){
        P=p; I=i; D=d; F=f;
        checkSigns();
    }
     ...
     * @see CommonPid - getOutput(actual) <br>
     * @param setpoint
     */
